...
- [x] site-growth.7 Comparisons cluster (7 pages) — dig vs mem0 · Letta/MemGPT · LlamaIndex · Obsidian · Zep · vector-DB · RAG-SaaS, sourced from docs/landscape.md (already written). #53: 3/7 (mem0, letta-memgpt, obsidian); DONE 2026-06-15: +4 (llamaindex, zep, vector-db, rag-saas) → 7/7, facts sourced from landscape.md, E2E + build-prerender verified
- [x] site-growth.8 Concepts/learn cluster (10 pages) — agent memory, MCP, hybrid retrieval (FTS+vector RRF), content-addressed store, drift detection, recall@k/hit@5, local-first AI, reversible changesets, …; sourced from architecture.md + evals.md. #53: 6 MDX (agent-memory, hybrid-retrieval, what-is-mcp + 3 SDK guides); DONE 2026-06-15: +5 concepts (content-addressed-store, drift-detection, recall-at-k, local-first-ai, reversible-changesets) → 11 pages, facts sourced from architecture.md + evals.md
- [x] site-growth.9 Use-cases cluster (8 pages) — agent memory, RAG over local files, dedupe a doc library, organize an Obsidian vault, PARA/GTD/Zettelkasten, research notes, meeting transcripts, second brain. #53: 2/8 (agent-memory, rag-local-files); DONE 2026-06-15: +6 (dedupe-library, obsidian-vault, para-gtd-zettelkasten, research-notes, meeting-transcripts, second-brain) → 8/8, shipped-features-only (no unshipped presets/graph claims)

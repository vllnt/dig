...
- **One-line positioning:** *"an open, local, extensible agent harness that keeps your knowledge base organized to your rules — detects drift, fixes it reversibly, runs in parallel, and works with a small local model."*
...
- Local LLM endpoints (OpenAI-compatible): [Ollama](https://ollama.com/) · [llama.cpp](https://github.com/ggml-org/llama.cpp) · [LM Studio](https://lmstudio.ai/) · [vLLM](https://github.com/vllm-project/vllm)

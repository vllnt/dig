...
| `dig retain [file]` | Capture content (a file, or stdin) into the KB and index it — the agent-memory capture primitive; dated `memory/` path by default (`--as`, `--date`) | planned |
